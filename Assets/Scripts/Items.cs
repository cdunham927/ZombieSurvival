...
public class Items : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (canPickup)
        {
            ...
            {
                if (PlayerController.player.money > cost) buyText.text = "<color=white>" + weaponName + " - </color>" + "<color=yellow> $" + cost.ToString() + "</color>\n";
                else buyText.text = "<color=white>" + weaponName + " - </color>" + "<color=red> $" + cost.ToString() + "</color>\n";
            }
            //Player has weapon, they can buy ammo
            //show buytext
            else
            {
                if (PlayerController.player.money > ammoCost) buyText.text = "<color=white>" + weaponName + " ammo - </color>" + "<color=yellow> $" + cost.ToString() + "</color>\n";
                else buyText.text = "<color=white>" + weaponName + " ammo - </color>" + "<color=red> $" + ammoCost.ToString() + "</color>\n";
            }
