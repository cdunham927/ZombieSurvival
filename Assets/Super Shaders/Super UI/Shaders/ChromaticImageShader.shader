Shader "Super/UI/ChromaticShader"
{
	Properties
	{
		...
		SubShader
		{
			...
			CGPROGRAM
				...
				fixed4 frag(v2f IN) : SV_Target
				{
					...
					fixed4 r = tex2D(_MainTex, IN.texcoord + d * _ChromaticOffset) * IN.color;
					fixed4 g = tex2D(_MainTex, IN.texcoord + d * _ChromaticOffset * 2) * IN.color;
					fixed4 b = tex2D(_MainTex, IN.texcoord + d * _ChromaticOffset * 3) * IN.color;

					color.a = (r.a + g.a + b.a) / 3;
